-- Create survey invitations table to track unique links per campaign
...
-- Create policies for survey invitations
...
-- Add a column to survey_response to track which invitation was used
...
CREATE INDEX idx_survey_response_invitation_token ON public.survey_response(invitation_token);