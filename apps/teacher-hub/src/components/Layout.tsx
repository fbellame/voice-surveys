...
interface LayoutProps {
  ...
  currentPage?: "lessons" | "answers" | "analytics" | "students";
}
...
export function Layout({ children, currentPage }: LayoutProps) {
  ...
  const navigation = [
    { name: "Lessons", href: "/lessons", icon: BookOpen, current: currentPage === "lessons" },
    { name: "Students", href: "/students", icon: Users, current: currentPage === "students" },
      ...
      <div className="mt-auto">
        <div className="rounded-lg bg-gradient-card p-4 border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium">Teacher Hub</p>
              <p className="text-xs text-muted-foreground">Manage lessons</p>
            </div>
          </div>
        </div>
      </div>
